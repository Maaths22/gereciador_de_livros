package com.projetofinal.gerenciadordelivros.adapter;
...
public class LivroAdapter extends RecyclerView.Adapter<LivroAdapter.LivroHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull LivroAdapter.LivroHolder holder, int position) {
        ...
        if(livro.getEmprestado() == 1){
            ...
            holder.ic_livro.setColorFilter(R.color.colorPrimaryDark);
